          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-10 flex flex-wrap justify-center lg:justify-start gap-y-2 gap-x-6 text-sm text-slate-500 font-medium">
              <div className="flex items-center gap-1.5">
                ...
                <span>{t('landing.heroFeature1')}</span>
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-green-500" />
                <span>{t('landing.heroFeature2')}</span>
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-green-500" />
                <span>{t('landing.heroFeature3')}</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 w-full relative group">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl hidden md:block animate-bounce">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-slate-500 font-semibold uppercase">{t('landing.heroStatusLabel')}</p>
                  <p className="text-sm font-bold text-slate-800">{t('landing.heroStatusValue')}</p>
                </div>
              </div>
            </div>
          </div>
