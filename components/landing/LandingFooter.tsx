        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white tracking-tight">{t('landing.brandName')}</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <button className="hover:text-primary-400 transition-colors">{t('footer.relocationPlan')}</button>
              </li>
              <li>
                <button className="hover:text-primary-400 transition-colors">{t('footer.communityEvents')}</button>
              </li>
              <li>
                <button className="hover:text-primary-400 transition-colors">{t('footer.explorePlaces')}</button>
              </li>
            </ul>
          </div>
